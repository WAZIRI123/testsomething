C:\wamp64\www\akaunting\resources\views\purchases\bills\create.blade.php

SUBCOMPONENT
C:\wamp64\www\akaunting\resources\views\components\layouts\admin.blade.php
C:\wamp64\www\akaunting\resources\views\components\documents\form\content.blade.php
...
$document-from Controller component=false
$type-from parent component=bill
...
LEVEL5(1 components\AkauntingContactCard.vue)
...
LEVEL7(1 vue2-transitions)
it is built in

LEVEL7(2 js\components\AkauntingModal.vue)
PROPS
...
C:\wamp64\www\akaunting\resources\assets\js\components\AkauntingSelect.vue @add-new-component=this.add_new_html
...
LEVEL7(3 components\AkauntingModal.vue)
ALREADY

LEVEL7(4 components\AkauntingMoney.vue)
ALREADY
LEVEL7(5 components\AkauntingRadioGroup.vue)
ALREADY

LEVEL7(6 components\AkauntingSelect.vue)
ALREADY

LEVEL7(7 components\AkauntingSelectRemote.vue)
SUBCOMPONENT (ALREADY)
...
LEVEL7(8 components\AkauntingDate.vue)
ALREADY

LEVEL7(9 components\AkauntingRecurring.vue)
ALREADY

LEVEL7(10 js\plugins\form.js)

LEVEL7(11 js\mixins\global.js)
SUBCOMPONENT
...
LEVEL8(1 components\AkauntingDropzoneFileUpload.vue)
PROPS 
...
LEVEL8(2 components\AkauntingContactCard.vue)
SUBCOMPONENT{ALREADY}
import Vue from 'vue';
...
LEVEL8(3 components\AkauntingContactCard.vue)
ALREADY

LEVEL8(4 components\AkauntingCompanyEdit.vue)
ALREADY

LEVEL8(5 components\AkauntingEditItemColumns.vue)
DYNAMICCOMPONENT {ALREADY}
add-new-component
...
LEVEL8(6 components\AkauntingItemButton.vue)
SUBCOMPONENT {ALREADY}
import Vue from 'vue';
...
LEVEL8(7 components\AkauntingDocumentButton.vue)
PROPS
...
LEVEL9(8 components\AkauntingSearch.vue)
PROPS 
...
LEVEL9(9 components\AkauntingHtmlEditor.vue)
PROPS 
...
LEVEL9(10 components\AkauntingCountdown.vue)
PROPS 
...
LEVEL9(11 components\AkauntingCurrencyConversion.vue)
PROPS
...
LEVEL9(12 components\AkauntingConnectTransactions.vue)
PROPS
...
LEVEL9(13 components\AkauntingSwitch.vue)
PROPS
...
LEVEL9(14 components\AkauntingSlider.vue)
PROPS
name,video, screenshots,height,arrow, pagination,type,sliderView,sliderRow

LEVEL9(15 components\AkauntingColor.vue)
PROPS
...
config('type . document . bill .alias')=''

folder=''
config('type.' . static::OBJECT_TYPE . '.' . $type . '.script.folder')=config('type. document .invoice.script.folder')=common

file=''
config('type.' . static::OBJECT_TYPE . '.' . $type . '.script.file')=config('type.document . bill.script.file')=documents
